...
// MD5 CUDA kernel for brute force attack
// Launches one thread per candidate key
__global__ void md5_crack_kernel(
    const uint8_t* target_hash,      // Target MD5 hash (16 bytes)
...
// Host function to launch MD5 cracking
